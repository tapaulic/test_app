...
/*
 The main javascript file for test_app.
 IMPORTANT:
 ...
 This is because this app's files will exist on an S3 bucket resources/test_app
...
$(function () {
  ...
  console.log('running on env: ', 'local');

  var ccAPI = 'https://was-inter-sit.toronto.ca/cc_sr_v1/' + '/data/my_data_feed';
  var customVar = 'SOME_ENV will have this value in the local build environment';
  ...
  var sampleDataObject = new CotModel({
  ...
  form.render($('.test_app_container'));
});